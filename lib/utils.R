...
# Sort unique values and collapse to a string.  Useful in dplyr summarize after
# a group_by when collapsing multiple values in a group. NAs are omitted unless
# all values are NA in which case returns NA.
# Examples:
