...
ok_bt <- bunching_test(ok, division, hour_of_day, age_group, vehicle_make)
ok_bt$results$plots$over
ok_bt$results$plots$coefficient
ok_bt$results$plots$bunching
ok_bt$results$plots$lenience
```
