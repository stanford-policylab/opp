...
`r pfs$basic_counts$collected$n_stops` traffic stops carried out by 
`r pfs$basic_counts$collected$n_states` state patrol agencies and 
`r pfs$basic_counts$collectec$n_cities` municipal police departments.

We analyzed a unique dataset detailing 
`r pfs$basic_counts$analyzed$n_stops` traffic stops carried out by 
`r pfs$basic_counts$analyzed$n_states` state patrol agencies and 
`r pfs$basic_counts$analyzed$n_cities` municipal police departments.
