...
```{r load_pfs}
# pfs <- read_rds(here::here("results", "prima_facie_stats.rds"))
pfs <- read_rds("/share/data/opp/results/prima_facie_stats.rds")
```
```{r load_vod}
# vod <- read_rds(here::here("results", "veil_of_darkness.rds"))
vod <- read_rds("/share/data/opp/results/veil_of_darkness.rds")
```
```{r load_disp}
# disp <- read_rds(here::here("results", "disparity.rds"))
disp <- read_rds("/share/data/opp/results/disparity.rds")
```
```{r load_mj}
# mj <- read_rds(here::here("results", "marijuana_legalization_analysis.rds"))
mj <- read_rds("/share/data/opp/results/marijuana_legalization_analysis.rds")
```
